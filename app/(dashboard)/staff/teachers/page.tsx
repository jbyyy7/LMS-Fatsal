  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-12 text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-700 mb-2">Kelola Guru Sekolah</h2>
        <p className="text-gray-500">Fitur ini sedang dalam pengembangan</p>
        <p className="text-sm text-gray-400 mt-2">Staff dapat mengelola guru di sekolahnya</p>
      </Card>
    </div>
  );
}
